...
\t\tThe output of this program will be a directory which will contain max 4 files and 1 directory (different outputs give
\t\tdifferent number and combination of outputs):
